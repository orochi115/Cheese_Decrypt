...
> 记录 B 站课堂（cheese）DRM 下载改造的协议发现、实现说明与踩坑。  
...
**背景**：
- 起点是看雪论坛 2025-08 文章（[`bilibili_drm_流程分析笔记.md`](references/kanxue-thread-287970/bilibili_drm_流程分析笔记.md)）整理的分析，描述了一条 Widevine→ClearKey fallback 的旧链路。
...
- 看雪原文离线版：[references/kanxue-thread-287970/article.html](references/kanxue-thread-287970/article.html)
- 看雪原文（在线）：https://bbs.kanxue.com/thread-287970.htm
